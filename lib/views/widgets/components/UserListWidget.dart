...
class UserListWidget extends StatefulWidget {
  ...
  UserListWidget({Key? key, required this.idUser, this.group, required this.isAdmin, this.groupReturn})
      : super(key: key);
                        ...
                        children: [
                          ...
                          Text(
                              widget.group?.members?.firstWhere((element) => element['id'] == widget.idUser)['type'] ??
                                  '',
                              style: widget.group?.members
                                              ?.firstWhere((element) => element['id'] == widget.idUser)['type'] ==
                                          'Alumno' ||
                  ...
                  child: Material(
                    child: PopupMenuButton<String>(
                      ...
                      itemBuilder: (BuildContext context) {
                        return [
                          widget.group?.members
                                      ?.firstWhere((element) => element['id'] == widget.idUser)['writePermission'] ==
                                  true
                              ? PopupMenuItem<String>(
                                  value: 'silenciar',
                                  child: Container(
                                    decoration:
                                        const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(10.0))),
