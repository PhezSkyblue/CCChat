          ...
          children: [
                                            ...
                                            children: [
                                              TextSpan(
                                                ...
                                                style: title().copyWith(
                                                    decoration: TextDecoration.underline, color: MyColors.green),
                                              ),
                                            ],
                                          ),
                                        ),
            ...
            Padding(
              padding: Responsive.isMobile(context)
                  ...
                  : EdgeInsets.only(left: size.width / 4, right: size.width / 4, top: 40.0),
              child: Form(
                key: _formKey,
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        if ((typeController.text == "Alumno" && emailController.text.contains("@unex.es")) ||
                            ((typeController.text == "Profesor" || typeController.text == "Administrativo") &&
                                emailController.text.contains("@alumnos.unex.es"))) {
                          showDialog(
                            context: context,
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                content: const Text('El correo introducido no corresponde a ese tipo de usuario.',
                            ...
                            showDialog(
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  ...
                                  backgroundColor: MyColors.background3,
                                  title:
                                      const Text('Registrado correctamente', style: TextStyle(color: MyColors.white)),
                                  content: const Text(
                                      'Se ha enviado un correo de verificación al correo introducido, verifique para iniciar sesión. Revise su carpeta de spam de Outlook.',
                                      style: TextStyle(color: MyColors.white)),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
                                  ...
                                  text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: "Inicia sesión aquí",
                                        style: title()
                                            .copyWith(decoration: TextDecoration.underline, color: MyColors.green),
                                      ),
                                    ],
                                  ),
                                ),
