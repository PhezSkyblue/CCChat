...
class MobileMenu extends StatefulWidget {
  const MobileMenu({Key? key, required this.onItemSelected, required this.user}) : super(key: key);
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: SvgPicture.asset(widget.icon,
                  colorFilter:
                      ColorFilter.mode(widget.isSelected ? MyColors.background3 : MyColors.grey, BlendMode.srcIn)),
            ),
          ),
        ),
      ),
